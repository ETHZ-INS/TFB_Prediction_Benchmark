...
The [TruSeq adapters](./data/annotation/truseq.PE.fa) were downloaded from: https://github.com/timflutre/trimmomatic/blob/master/adapters/TruSeq2-PE.fa and extended by the transposase entries.
